...
def run(config):
    ...
    for ep_i in range(0, config["n_episodes"], config["n_rollout_threads"]):
        ...
        for step in range(config["episode_length"]):
            ...
            print("step : %4d/%4d | rewards : %.4f %.4f %.4f %.4f %.4f %.4f %.4f %.4f" % (step, config["episode_length"], *episode_rewards), end='\r')
        ...
        print("episode : %6d/%6d | rewards : %.4f %.4f %.4f %.4f %.4f %.4f %.4f %.4f " % (ep_i, config["n_episodes"], *episode_rewards), end='\n\n')
